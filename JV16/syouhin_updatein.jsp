...
商品変更
<BR><BR>
<FORM name="frm" METHOD="POST" ACTION="./syouhin_updatecheck.jsp">
...
<tr>
  <td>商品No</td>
  <td>
    <input type="text" name="syouhin_no" size="10" maxlength="20" readonly value="<%= list.get(0).get("syou_no") %>">
  </td>
</tr>
<tr>
  <td bgcolor="#99CC00">商品名</td>
    <td>
      <input type="text" name="syouhin_name" size="50" maxlength="50" value="<%= list.get(0).get("syou_name") %>">
    </td>
  </tr>
  <tr>
    ...
    <td>
      <select size=1 name="syouhin_pre">
        ...
        <option value="18,福岡県">福井県</option>
        ...
        <option value="45,宮城県">宮崎県</option>
  ...
  <tr>
    ...
    <td>
      <textarea name="syouhin_msg" rows="3" cols="40" ><%= list.get(0).get("syou_msg") %></textarea>
    </td>
  </tr>
  <tr>
...
<form method="post" action="./syouhin_index.jsp">
  ...
  <a href="./syouhin_main.jsp">メインに戻る</a>
    ...
    <script>
    document.frm.syouhin_pre.selectedIndex=<%= list.get(0).get("syou_pre") %>-1;
    document.frm.syouhin_icon.selectedIndex=<%= list.get(0).get("syou_icon") %>-1;
  </script>
</body>
</html>
