    ...
    <form method="post" action="./answer2.jsp">
      <table border="1">
        ...
        <tr>
          ...
          <td>住所</td>
          <td>
            <input type="text" name="jyuusyo" size="40" maxlength="40">
          </td>
        </tr>
        <tr>
          <td>電話番号</td>
        ...
        <tr>
          <td>生年月日（年）</td>
          <td>
            <input type="text" name="nen" size="40" maxlength="4">
          </td>
        </tr>
        <tr>
          <td>生年月日（月）</td>
          <td>
            <input type="text" name="tuki" size="40" maxlength="2">
          </td>
        </tr>
        <tr>
          <td>生年月日（日）</td>
          <td>
            <input type="text" name="hi" size="40" maxlength="2">
          </td>
        </tr>
        <tr>
